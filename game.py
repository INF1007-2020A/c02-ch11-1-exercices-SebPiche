...
class Character:
	...
	# TODO: Affecter ce qui est passé comme valeur. Si la valeur est None, je lui met une arme vide (unarmed)
	@weapon.setter
	def weapon(self, val):
		if val is None:
	...
	# TODO: Définir getter/setter pour hp, qui dpoit être borbé entre 0 et 'max_hp'
	@property
	def hp(self):
		return self.__hp
